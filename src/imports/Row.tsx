import svgPaths from "./svg-48t0n1ws40";
    ...
    <div className="absolute inset-[12.5%_0.08%_15.45%_0]" data-name="icon/logo">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.9739 23.0548">
        <g id="icon/logo">
          ...
          <mask height="24" id="mask0_3_1989" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="32" x="0" y="0">
...
function Frame3() {
  return (
    <div className="content-stretch flex font-['Nobel:Bold',sans-serif] gap-[16px] items-center leading-[1.15] not-italic relative shrink-0 text-[22px] text-[rgba(0,0,0,0.9)] tracking-[1.1px] uppercase">
      ...
      <p className="relative shrink-0">row</p>
    </div>
  );
}
...
function Stack1() {
  return (
    <div className="content-stretch flex flex-col font-['Nobel:Book',sans-serif] gap-[16px] items-start not-italic relative shrink-0 w-[900px]" data-name="Stack">
      <p className="leading-[1.15] relative shrink-0 text-[49px] text-[rgba(0,0,0,0.9)] tracking-[2.45px] uppercase">row</p>
      <div className="flex flex-col justify-center leading-[0] min-w-full relative shrink-0 text-[#232632] text-[22px] tracking-[0.275px] w-[min-content]">
        <p className="leading-[1.3] whitespace-pre-wrap">{`A layout component which contains and positions the ‘cell’ component(s). `}</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-col font-['Nobel:Book',sans-serif] justify-center leading-[0] relative shrink-0 text-[#232632] text-[19px] w-full">
        <ul className="list-disc whitespace-pre-wrap">
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Use container values to limit the horizontal width of the row (12 col, 10 col, 8 col, 6 col)</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Inherit the theming of the section – content within the row will follow section theme</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Apply border radius if there is no gap value</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Add 1-4 cells into the row</span>
          </li>
          <li className="ms-[28.5px]">
            <span className="leading-[1.5]">Wrap 3 cells all at once, 4 cells in 2 steps: 2x2 and all 4 wrapped</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="flex flex-col font-['Nobel:Book',sans-serif] justify-center leading-[0] relative shrink-0 text-[#232632] text-[19px] w-full">
        <ul className="list-disc whitespace-pre-wrap">
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">No background/elevation colour</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Allow more than 4 cells</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">Do not apply Border Radius if gap is set above 0 (not none)</span>
          </li>
          <li className="ms-[28.5px]">
            <span className="leading-[1.5]">Do not use 4 cells with smaller than 12cols container</span>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div className="flex flex-col font-['Nobel:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#232632] text-[19px] w-full">
        <ul className="list-disc whitespace-pre-wrap">
          <li className="mb-0 ms-[28.5px]">
            ...
            <span className="font-['Nobel:Book',sans-serif] leading-[1.5] not-italic">default/none/no-vertical</span>
          </li>
          <li className="mb-0 ms-[28.5px]">
            <span className="leading-[1.5]">{`Border-radius: `}</span>
            <span className="font-['Nobel:Book',sans-serif] leading-[1.5] not-italic">{`Yes/No. If gap value is `}</span>
            <span className="leading-[1.5]">not</span>
            <span className="font-['Nobel:Book',sans-serif] leading-[1.5] not-italic">{` none value is ignored and No is used`}</span>
          </li>
          <li className="ms-[28.5px]">
            <span className="leading-[1.5]">{`Reverse wrapping: `}</span>
...
function Row1() {
  return (
    <div className="bg-[#b2b3f0] content-stretch flex gap-[40px] h-[24px] items-center justify-end max-w-[1280px] relative shrink-0 w-full" data-name="Row">
...
function Frame11() {
  return (
    <div className="bg-[#e3e1da] relative shrink-0 w-full">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-[40px] py-[64px] relative w-full">
          <Row1 />
        </div>
      </div>
    </div>
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-center justify-center left-[1049.5px] top-[165.04px]">
      <div className="flex flex-col font-['Nobel:Book',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ff47c0] text-[13px] whitespace-nowrap">
        <p className="leading-[16px]">Cell [slot]</p>
      </div>
      <div className="flex h-[26.961px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-0 relative w-[26.961px]">
            <div className="absolute inset-[-2.67px_-9.89%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32.2944 5.33333">
                <path d={svgPaths.p357f8380} fill="var(--stroke-0, #FF47C0)" id="Vector 16" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-center justify-center left-[275.02px] top-[96.54px]">
      <div className="flex flex-col font-['Nobel:Book',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#9747ff] text-[13px] whitespace-nowrap">
        <p className="leading-[16px]">Row</p>
      </div>
      <div className="flex h-[81.369px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-0 relative w-[81.369px]">
            <div className="absolute inset-[-2.67px_-3.28%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 86.7022 5.33333">
                <path d={svgPaths.p14a89780} fill="var(--stroke-0, #9747FF)" id="Vector 16" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-center justify-center left-[37.02px] top-[292.43px] w-[219px]">
      <div className="flex h-[34.22px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-0 relative w-[34.22px]">
            <div className="absolute inset-[-2.67px_-7.79%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39.5529 5.33333">
                <path d={svgPaths.pb675e80} fill="var(--stroke-0, #232632)" fillOpacity="0.5" id="Vector 16" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-col font-['Nobel:Book',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-[rgba(35,38,50,0.5)] whitespace-nowrap">
        <p className="leading-[16px]">
          Section. Controls the horiztonal padding width
          <br aria-hidden="true" />
          {` between edge of screen  and row and the vertical`}
          <br aria-hidden="true" />
...
function PreviewFrame() {
  return (
    <div className="bg-[#f6f5f3] content-stretch flex flex-col gap-[40px] items-center justify-center px-[24px] py-[140px] relative rounded-[5px] shrink-0 w-[1792px]" data-name="Preview Frame">
      ...
      <Frame13 />
      <Frame12 />
      <div className="absolute h-[77px] left-[256.02px] top-[248.54px] w-[1280px]" data-name="Measure Line">
        <div className="-translate-x-1/2 absolute bottom-[-12px] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] left-[calc(50%+0.5px)] not-italic text-[#ea10ac] text-[12px] text-center translate-y-1/2 whitespace-nowrap">
          <p className="leading-[18px]">Container controls this width. Row is set to fill this space.</p>
        </div>
                  ...
                  <div className="h-full relative w-[78px]" data-name="Line">
                    <div className="absolute inset-[-0.5px_0]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1278 1">
                        <path d="M0 0.5H1278" id="Line" stroke="var(--stroke-0, #EA10AC)" />
                      </svg>
                    </div>
                  </div>
                </div>
      ...
      <div className="absolute h-[143px] left-[546.02px] top-[84.54px] w-[40px]" data-name="Measure Line">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] left-[calc(50%+0.5px)] not-italic text-[#ea10ac] text-[12px] text-center top-[-12px] whitespace-nowrap">
          <p className="leading-[18px]">Gap</p>
        </div>
        <div className="absolute flex inset-[16px_0_2px_0] items-center justify-center">
          <div className="-rotate-90 flex-none h-[56px] w-[38px]">
            <div className="relative size-full" data-name=".Line">
              <div aria-hidden="true" className="absolute border-[#ea10ac] border-b border-dashed border-t inset-0 pointer-events-none" />
            </div>
          </div>
        </div>
        <div className="absolute flex h-[12px] items-center justify-center left-0 right-0 top-0">
          <div className="flex-none h-[56px] rotate-90 w-[12px]">
            <div className="content-stretch flex flex-col items-center relative size-full" data-name=".Measure">
              <div className="bg-[#ea10ac] h-px shrink-0 w-[12px]" data-name="Endpoint" />
              <div className="flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
...
function Stack25() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Stack">
      <div className="h-[49px] relative shrink-0 w-[32px]" data-name="Nest-Line">
        <div className="absolute flex h-[49px] items-center justify-center left-0 top-0 w-[12px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
          <div className="flex-none rotate-90">
...
function Row2() {
  return (
    <div className="bg-[#ffd1ef] content-stretch flex h-[24px] items-center justify-end max-w-[1280px] relative shrink-0 w-full" data-name="Row">
      <div aria-hidden="true" className="absolute border border-[#9747ff] border-dashed inset-[-1px] pointer-events-none" />
      <Cell4 />
    </div>
  );
...
function Row3() {
  return (
    <div className="bg-[rgba(25,141,230,0.25)] content-stretch flex h-[24px] items-center justify-end max-w-[1280px] relative shrink-0 w-full" data-name="Row">
      <div aria-hidden="true" className="absolute border border-[#9747ff] border-dashed inset-[-1px] pointer-events-none" />
      <Cell5 />
      <Cell6 />
    </div>
...
function PreviewFrame1() {
  return (
    <div className="bg-[#dfdcd4] content-stretch flex flex-col gap-[40px] items-center justify-center px-[24px] py-[80px] relative rounded-[5px] shrink-0 w-[1792px]" data-name="Preview Frame">
      <div aria-hidden="true" className="absolute border border-[rgba(23,23,23,0.1)] border-solid inset-0 pointer-events-none rounded-[5px]" />
      <Row2 />
      <Row3 />
      <Row4 />
...
function Stack28() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Stack">
      <p className="font-['Nobel:Bold',sans-serif] leading-none min-w-full not-italic relative shrink-0 text-[#232632] text-[12px] tracking-[1.44px] uppercase w-[min-content] whitespace-pre-wrap">rows with no gap (eg. 12 col width)</p>
      <PreviewFrame1 />
    </div>
  );
}
...
function Stack29() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Stack">
      <p className="font-['Nobel:Bold',sans-serif] leading-none min-w-full not-italic relative shrink-0 text-[#232632] text-[12px] tracking-[1.44px] uppercase w-[min-content] whitespace-pre-wrap">rows with gap (eg. 12 col width)</p>
      <PreviewFrame2 />
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[16px] relative w-full">
          <div className="font-['Courier_New:Regular',sans-serif] leading-[1.15] not-italic relative shrink-0 text-[24px] text-black tracking-[2.45px] w-[776px] whitespace-pre-wrap">
            ...
            <p className="mb-[16px]">{`    "row": {`}</p>
            <p className="mb-[16px]">{`      "border-radius": {`}</p>
            <p className="mb-[16px]">{`        "value": "{sem.border-radius.extra-large}",`}</p>
            <p className="mb-[16px]">{`        "type": "borderRadius",`}</p>
            <p className="mb-[16px]">{`        "description": "8px default border radius for the row component."`}</p>
            <p className="mb-[16px]">{`      },`}</p>
            <p className="mb-[16px]">{`      "gap": {`}</p>
            <p className="mb-[16px]">{`        "value": "{sem.dim.scale.d-4}",`}</p>
            <p className="mb-[16px]">{`        "type": "dimension",`}</p>
            <p className="mb-[16px]">{`        "description": "40px gap. With scaling to match grid col gaps."`}</p>
            <p className="mb-[16px]">{`      }`}</p>
            <p className="mb-[16px]">{`    }`}</p>
            <p className="mb-[16px]">{`  }`}</p>
            <p>{`}`}</p>
...
export default function Row() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Row">
      <Container />
    </div>
  );
}